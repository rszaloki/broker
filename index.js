...
var SERVICE_NAME =
  process.env.SERVICE_NAME || "testnoderesourceservicebrokername";

// TODO - Change your basic authentication credentials
var SERVICE_BROKER_USER =
  process.env.SERVICE_BROKER_USER || "TestServiceBrokerUser";
var SERVICE_BROKER_PASSWORD =
  process.env.SERVICE_BROKER_PASSWORD || "TestServiceBrokerPassword";

// TODO - Change your client secret
var CLIENT_ID = process.env.CLIENT_ID || SERVICE_NAME;
...
var IAM_ENDPOINT = process.env.IAM_ENDPOINT || "https://iam.cloud.ibm.com";
var IAM_IDENTITY_ENDPOINT =
  IAM_ENDPOINT + "/identity/.well-known/openid-configuration";
...
var getOriginatingIdentity = function (request) {
  var originatingIdentityHeader = request.get(
    ...
    try {
      ...
      localResponse.on("end", function () {
        ...
        if (statusCode == 200) {
          ...
          console.log(
            "%s to %s is unauthorized. Response: %j",
            method,
            urlString,
            json
          );
          ...
          console.log(
            "%s to %s is forbidden. Response: %j",
            method,
            urlString,
            json
          );
          ...
          console.log(
            "%s to %s is not found. Response: %j",
            method,
            urlString,
            json
          );
          ...
          var jsonError = {
            description:
              "Unexpected return code from url " +
              urlString +
              " is " +
              statusCode,
          };
...
var manageServiceInstance = function (
  request,
  response,
  accessToken,
  apiToken,
  ...
  try {
    accessTokenBodyJSON = JSON.parse(
      new Buffer(accessToken.split(".")[1], "base64").toString("ascii")
    );
  ...
  var localCallback = function (json) {
    try {
      if (json == null) {
        ...
        var arrayEntry = getJSONArrayEntry(
          json,
          "responses",
          0,
          true,
        ...
        var authorizationDecision = getObject(
          arrayEntry,
        ...
        callback(
          getBoolean(authorizationDecision, "permitted", true, response)
        );
      }
    } catch (exception) {
      console.log(exception);
...
var catalog = function (request, response) {
  ...
  try {
    ...
    console.log(
      "GET /v2/catalog originating identity: %s",
      JSON.stringify(originatingIdentity)
    );
...
var provision = function (request, response) {
  ...
  console.log(
    "PUT /v2/service_instances/%s?accepts_incomplete=%s request headers: %j",
    instanceId,
    acceptsIncomplete,
    request.headers
  );
  ...
  try {
    ...
    var originatingIdentity = getOriginatingIdentity(request);
    console.log(
      "PUT /v2/service_instances/%s?accepts_incomplete=%s originating identity: %s",
      instanceId,
      acceptsIncomplete,
      JSON.stringify(originatingIdentity)
    );
    ...
    console.log(
      "PUT /v2/service_instances/%s?accepts_incomplete=%s body: %j",
      instanceId,
      acceptsIncomplete,
      body
    );
    ...
    if (ASYNC_SUPPORTED && ASYNC_REQUIRED && !acceptsIncomplete) {
      result = {
        error: "AsyncRequired",
        description:
          "This service plan requires client support for asynchronous service operations.", // TODO - This optional field is a user-facing message
      };
      ...
      if (ASYNC_SUPPORTED && acceptsIncomplete) {
        ...
        result = {
          ...
          description:
            "This service instance is being created asynchronously for you.", // TODO - This optional field is a user-facing message.
    ...
    console.log(
      "PUT /v2/service_instances/%s?accepts_incomplete=%s status: %d, result: %j",
      instanceId,
      acceptsIncomplete,
      status,
      result
...
var bind = function (request, response) {
  ...
  console.log(
    "PUT /v2/service_instances/%s/service_bindings/%s request headers: %j",
    instanceId,
    bindingId,
    request.headers
  );
  ...
  try {
    ...
    var originatingIdentity = getOriginatingIdentity(request);
    console.log(
      "PUT /v2/service_instances/%s/service_bindings/%s originating identity: %s",
      instanceId,
      bindingId,
      JSON.stringify(originatingIdentity)
    );
    ...
    console.log(
      "PUT /v2/service_instances/%s/service_bindings/%s body: %j",
      instanceId,
      bindingId,
      body
    );
    ...
    if (appGuid == null && !SERVICE_KEYS_SUPPORTED) {
      result = {
        error: "RequiresApp",
        description:
          "This service supports generation of credentials through binding an application only.", // TODO - This optional field is a user-facing message
      };
    ...
    console.log(
      "PUT /v2/service_instances/%s/service_bindings/%s status: %d, result: %j",
      instanceId,
      bindingId,
      status,
      result
...
var unbind = function (request, response) {
  ...
  console.log(
    "DELETE /v2/service_instances/%s/service_bindings/%s?plan_id=%s&service_id=%s request headers: %j",
    instanceId,
    bindingId,
    planId,
    serviceId,
  ...
  try {
    ...
    var originatingIdentity = getOriginatingIdentity(request);
    console.log(
      "DELETE /v2/service_instances/%s/service_bindings/%s?plan_id=%s&service_id=%s originating identity: %s",
      instanceId,
      bindingId,
      planId,
      serviceId,
    ...
    console.log(
      "DELETE /v2/service_instances/%s/service_bindings/%s?plan_id=%s&service_id=%s result: %j",
      instanceId,
      bindingId,
      planId,
      serviceId,
...
var unprovision = function (request, response) {
  ...
  console.log(
    "DELETE /v2/service_instances/%s?accepts_incomplete=%s&plan_id=%s&service_id=%s request headers: %j",
    instanceId,
    acceptsIncomplete,
    planId,
    serviceId,
  ...
  try {
    ...
    var originatingIdentity = getOriginatingIdentity(request);
    console.log(
      "DELETE /v2/service_instances/%s?accepts_incomplete=%s&plan_id=%s&service_id=%s originating identity: %s",
      instanceId,
      acceptsIncomplete,
      planId,
      serviceId,
    ...
    // TODO - Else if the service instance is requested as asynchronous (and time is needed to deprovision beyond the standard timeout)
      ...
      result = {
        description:
          "This service instance is being deleted asynchronously for you.", // TODO - This optional field is a user-facing message.
    ...
    console.log(
      "DELETE /v2/service_instances/%s?accepts_incomplete=%s&plan_id=%s&service_id=%s status: %d, result: %j",
      instanceId,
      acceptsIncomplete,
      planId,
      serviceId,
...
var update = function (request, response) {
  ...
  console.log(
    "PATCH /v2/service_instances/%s?accepts_incomplete=%s request headers: %j",
    instanceId,
    acceptsIncomplete,
    request.headers
  );
  ...
  try {
    ...
    var originatingIdentity = getOriginatingIdentity(request);
    console.log(
      "PATCH /v2/service_instances/%s?accepts_incomplete=%s originating identity: %s",
      instanceId,
      acceptsIncomplete,
      JSON.stringify(originatingIdentity)
    );
    ...
    console.log(
      "PATCH /v2/service_instances/%s?accepts_incomplete=%s body: %j",
      instanceId,
      acceptsIncomplete,
      body
    );
    ...
    // TODO - Else if the service instance is requested as asynchronous (and time is needed to update beyond the standard timeout)
      ...
      result = {
        description:
          "This service instance is being updated asynchronously for you.", // TODO - This optional field is a user-facing message.
    ...
    console.log(
      "PATCH /v2/service_instances/%s?accepts_incomplete=%s status: %d, result: %j",
      instanceId,
      acceptsIncomplete,
      status,
      result
...
var fetch = function (request, response) {
  ...
  console.log(
    "GET /v2/service_instances/%s/last_operation?operation=%s&plan_id=%s&service_id=%s request headers: %j",
    instanceId,
    operation,
    planId,
    serviceId,
  ...
  try {
    ...
    console.log(
      "GET /v2/service_instances/%s/last_operation?operation=%s&plan_id=%s&service_id=%s result: %j",
      instanceId,
      operation,
      planId,
      serviceId,
...
var dashboard = function (request, response) {
  ...
  console.log(
    "GET /dashboard/%s request headers: %j",
    instanceId,
    request.headers
  );
...
var sso_dashboard = function (request, response) {
  ...
  console.log(
    "GET /sso_dashboard?code=%s&state=%s request headers: %j",
    code,
    state,
    request.headers
  );
  ...
  try {
    var manageServiceInstanceCallback = function (manageServiceInstanceResult) {
      if (manageServiceInstanceResult) {
        ...
        response
          .status(401)
          .send("You are not authorized to manage this service instance");
      }
    };
...
var enable = function (request, response) {
  ...
  console.log(
    "PUT /bluemix_v1/service_instances/%s request headers: %j",
    instanceId,
    request.headers
  );
  ...
  try {
    ...
    console.log(
      "PUT /bluemix_v1/service_instances/%s body: %j",
      instanceId,
      body
    );
...
var state = function (request, response) {
  ...
  console.log(
    "GET /bluemix_v1/service_instances/%s request headers: %j",
    instanceId,
    request.headers
  );
  ...
  try {
    ...
    console.log(
      "GET /bluemix_v1/service_instances/%s result: %j",
      instanceId,
      result
    );
